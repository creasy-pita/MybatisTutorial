...
public class SecondLevelCacheTest
{
    public static void main(String[] args) {
        ...
        User firstSelectWithCache = firstMapper.selectByIdWithSecondLevelCache(1);
        System.out.println("first session first query with cache:" + firstSelectWithCache.getName());
        User secondSelectWithCache = firstMapper.selectByIdWithSecondLevelCache(1);
        ...
        firstSelectWithCache = secondMapper.selectByIdWithSecondLevelCache(1);
        System.out.println("second Session first query with cache:" + firstSelectWithCache.getName());
        secondSelectWithCache = secondMapper.selectByIdWithSecondLevelCache(1);
